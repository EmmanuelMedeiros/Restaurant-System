...
export class OrderEndpoint {
    ...
    async finishOrder(orderUUID: string, jwtToken: string|null): Promise<IApiResponse> {
        
        let apiResponse: IApiResponse;

        const apiResult = await axios.put(`${this.apiUrl}/order/finish/${orderUUID}`, 
            {
    ...
    async printOrder(orderUUID: string, jwtToken: string|null): Promise<IApiResponse> {

        let apiResponse: IApiResponse;

        const apiResult = await axios.get(`${this.apiUrl}/order/print/${orderUUID}`, {
            headers: {
                Authorization: `Bearer ${jwtToken}`
            }
        })
